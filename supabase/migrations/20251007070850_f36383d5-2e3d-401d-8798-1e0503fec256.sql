-- Add news management permissions for manager role
-- This ensures managers can create, edit, and delete news articles

-- Update the seed_company_role_permissions function to include news permissions for managers
...
BEGIN
  ...
  -- News Management (NEW)
  INSERT INTO role_permissions (company_id, role, permission_key, enabled) VALUES
    (_company_id, 'manager', 'create_news_article', true),
    (_company_id, 'manager', 'publish_news_article', true),
    (_company_id, 'manager', 'delete_news_article', true);
  ...
  -- News Management (NEW)
  INSERT INTO role_permissions (company_id, role, permission_key, enabled) VALUES
    (_company_id, 'marketing_manager', 'create_news_article', true),
    (_company_id, 'marketing_manager', 'publish_news_article', true),
    (_company_id, 'marketing_manager', 'delete_news_article', true);
  ...
  -- News Management (NEW)
  INSERT INTO role_permissions (company_id, role, permission_key, enabled) VALUES
    (_company_id, 'tenant_admin', 'create_news_article', true),
    (_company_id, 'tenant_admin', 'publish_news_article', true),
    (_company_id, 'tenant_admin', 'delete_news_article', true);
...
-- Apply the updated permissions to all existing companies
DO $$
DECLARE
