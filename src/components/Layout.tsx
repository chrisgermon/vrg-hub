            ...
            <div className="flex items-center gap-2 md:gap-4 w-full md:w-auto">
              ...
              <NavigationMenu className="hidden lg:flex">
                <NavigationMenuList>
                  ...
                  <NavigationMenuItem>
                    <NavigationMenuLink asChild>
                      <Link to="/mission" className="group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50">
                        Mission Statement
                      </Link>
                    </NavigationMenuLink>
                  </NavigationMenuItem>
